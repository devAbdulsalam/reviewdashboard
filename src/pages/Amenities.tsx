...
import { fetchAmenities } from '../hooks/axiosApis.js';
...
const AddAmenity = () => {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['amenities'],
    queryFn: async () => fetchAmenities(user),
  });
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    axios
      .post(`${apiUrl}/amenities`, data, config)
      .then((res) => {
        if (res.data) {
  ...
  const handleDelete = (id: any) => {
    Swal.fire({
      title: 'Are you sure?',
      text: `These Amenity would be deleted!`,
      icon: 'question',
      ...
      if (result.isConfirmed) {
        setLoading(true);
        axios
          .delete(`${apiUrl}/amenities/${id}`, config)
          .then((res) => {
            if (res.data) {
