...
import { fetchAdvert } from '../hooks/axiosApis';
...
const Advert = () => {
  ...
  const handelEdit = () => {
    navigate(`/adverts/${id}/edit-advert`);
  };
  const handelDelete = () => {
    Swal.fire({
      title: 'Are you sure?',
        ...
        axios
          ...
          .then((res) => {
            if (res.data) {
              ...
              queryClient.invalidateQueries(['adverts', id]);
              Swal.fire({
    ...
    <>
      ...
      <div>
        ...
        <div>
          ...
          <h3 className="font-semibold my-2">Advert info:</h3>
