...
const Settings = () => {
  ...
  const handleLGAChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!address) {
      return toast.error('Site Address is required!');
    }
    if (!email) {
      return toast.error('Site email is required!');
    }
    if (!phone) {
      return toast.error('Site phone is required!');
    }
    const data: FormData = {
      name,
      email,
    ...
    axios
      .patch(`${apiUrl}/general/site`, data, config)
      .then((res) => {
        if (res.data) {
  ...
  const handleChangeAvatar = async () => {
    ...
    setLoading(true);
    axios
      .patch(`${apiUrl}/general/site/logo`, formData, configFIle)
      .then((res) => {
        if (res.data) {
          Swal.fire({
                    ...
                    {image ? (
                      ...
                      <img
                        src={
                          ...
                          `https://ui-avatars.com/api/?name=review nigeria`
                        }
